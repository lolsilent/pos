...
mysql_query("TRUNCATE TABLE `$tbl_inventory`") or print(mysql_error());
...
$isql = "INSERT INTO `xbros_silent_pos`.`pos_work` (`id`, `name`, `task`, `outcome`, `clock`, `day`, `month`, `year`) VALUES 
(NULL, 'jim', 'temperatuur koeling keuken 1', '".number_format(rand(30,50)/10)."', '".date("H:i")."', ".date("j").", ".date("n").", ".date("Y").");";
mysql_query($isql) or print(mysql_error());

$isql = "INSERT INTO `xbros_silent_pos`.`pos_work` (`id`, `name`, `task`, `outcome`, `clock`, `day`, `month`, `year`) VALUES 
(NULL, 'jim', 'temperatuur toonbank keuken 2', '".number_format(rand(30,50)/10)."', '".date("H:i")."', ".date("j").", ".date("n").", ".date("Y").");";
mysql_query($isql) or print(mysql_error());
...
if ($tot_laag > 0) {
$emessage .= "INSERT INTO `boek_kas` (`id`, `user_id`, `a1`, `a2`, `a3`, `a4`, `a5`, `a6`, `a7`, `a8`, `a9`, `a10`, `a11`, `timer`) VALUES
(NULL, 1, '201', '$tot_day_name', '$tot_day', '$tot_month', '$tot_year', '', 'OMZET LAAG', '8010', '6', '$tot_laag', '0', $tot_time);";
}

if ($tot_nul > 0) {
$emessage .= "INSERT INTO `boek_kas` (`id`, `user_id`, `a1`, `a2`, `a3`, `a4`, `a5`, `a6`, `a7`, `a8`, `a9`, `a10`, `a11`, `timer`) VALUES
(NULL, 1, '202', '$tot_day_name', '$tot_day', '$tot_month', '$tot_year', '', 'OMZET NUL', '8020', '', '$tot_nul', '0', $tot_time);";
}

if ($gepined > 0) {
$emessage .= "INSERT INTO `boek_kas` (`id`, `user_id`, `a1`, `a2`, `a3`, `a4`, `a5`, `a6`, `a7`, `a8`, `a9`, `a10`, `a11`, `timer`) VALUES
(NULL, 1, '205', '$tot_day_name', '$tot_day', '$tot_month', '$tot_year', '', 'Omzet Elektronisch', '8050', '', '-$gepined', '0', $tot_time);";
}
...
mail($myemail,"OMZET $edate","$emessage", $headers);
...
print '<iframe src="http://www.isushi.nl/interact.php?pas=1793&'.$val.'" style="width:5;height:5;"></iframe>';
}
...
<table><tr><td>
<h1 class=red><a href="http://www.isushi.nl?lockdown=1793">Emergency Lockdown</a></h1>
</td></tr></table>
<?
